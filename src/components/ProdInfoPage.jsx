            ...
            <div className="lg:w-[40%] md:w-[60%] sm:w-[70%] pt-5 flex flex-col justify-center align-middle ">
              ...
              <div>
                <div className="mt-5 flex justify-center align-middle">
                  <h4 className="text-dark-brown font-serif font-bold">
                    COLORS
                  </h4>
                  <ul className="flex justify-evenly">fgdf</ul>
                </div>
                <div className="flex justify-evenly align-middle mt-10">
                  ...
                  <div>
                    <button
                      onClick={addToCart}
                      className="w-[150px] h-10 bg-white text-brown rounded-lg text-dark-brown"
                    >
                      Add to Cart
                    </button>
                  </div>
