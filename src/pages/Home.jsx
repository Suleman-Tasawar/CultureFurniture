...
export default function Home() {
  return (
    <section className=" bg-primary w-[100%] h-full  flex justify-evenly align-middle lg:flex-col md:flex-col sm:flex-col ">
      <div className="mt-5 flex justify-evenly align-middle lg:flex-row md:flex-col sm:flex-col ">
        ...
        <div className="lg:w-[45%] md:w-[50%] sm:-w">
          ...
          <div className="mb-24">
            <button className="hover:bg-green-neutral  hover:text-white hover:transition mt-5 w-full h-[45px] bg-light-yellow text-background rounded-full">
              <Link to="/notify">Notify the Launch</Link>
            </button>
            <button className="hover:bg-dark-brown hover:text-white hover:transition-all mt-3 w-full h-[45px] bg-neutral-yellow text-background rounded-full">
              <Link to="/contact">Stay in touch</Link>
            </button>
          </div>
        </div>
      </div>
      <div className="flex justify-end p-4  bg-light-yellow w-[100%] h-[70px] rounded-lg">
